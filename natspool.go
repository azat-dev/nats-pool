...
// NatsPool is a simple connection pool for nats.io connections. It will create a small
...
func NewPoolCustom(addr string, size int, df DialFunc) (*NatsPool, error) {
...
func New(addr string, size int) (*NatsPool, error) {
